...
export function Header() {
  ...
  return (
    <header className="fixed -top-[40px] left-0 right-0 z-50 opacity-0 hover:opacity-100 transition-opacity duration-200 border-b border-border bg-background/80 backdrop-blur-sm hover:translate-y-[40px] transition-transform duration-200">
