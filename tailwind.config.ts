    ...
    extend: {
      ...
      colors: {
        ...
        'sidebar-primary': {
          ...
          hover: 'hsl(var(--sidebar-primary-hover) / <alpha-value>)',
          active: 'hsl(var(--sidebar-primary-active) / <alpha-value>)',
        ...
        'sidebar-accent': {
          ...
          hover: 'hsl(var(--sidebar-accent-hover) / <alpha-value>)',
          active: 'hsl(var(--sidebar-accent-active) / <alpha-value>)',
